...
MainFrame::MainFrame(const wxString &title) : wxFrame(nullptr, wxID_ANY, title)
{
    ...
    this->_inputPathTC = new wxTextCtrl(panel, wxID_ANY, "/home/inf/Projects/vendotek/input/test_mifare/ultralight/input_bulk_operation_ev1.json", wxPoint(150, 75), wxSize(200, -1));
