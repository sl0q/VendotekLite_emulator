...
MainFrame::MainFrame(const wxString &title) : wxFrame(nullptr, wxID_ANY, title)
{
    ...
    this->_inputPathTC = new wxTextCtrl(panel, wxID_ANY, "/home/inf/Projects/vendotek/input/test_mifare/classic/input_write_blocks.json", wxPoint(150, 75), wxSize(200, -1));
