...
#ifndef GOOGLE_PROTOBUF_INCLUDED_mifare_2fplus_2fread_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_mifare_2fplus_2fread_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_mifare_2fplus_2fread_2eproto
...
struct TableStruct_mifare_2fplus_2fread_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mifare_2fplus_2fread_2eproto;
namespace mifare {
namespace plus {
namespace read {
class Blocks;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::mifare::plus::read::Blocks* Arena::CreateMaybeMessage<::mifare::plus::read::Blocks>(Arena*);
template<> ::mifare::plus::read::ReadBlocks* Arena::CreateMaybeMessage<::mifare::plus::read::ReadBlocks>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mifare {
namespace plus {
namespace read {
...
class ReadBlocks :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mifare.plus.read.ReadBlocks) */ {
 public:
  ReadBlocks();
  virtual ~ReadBlocks();
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "mifare.plus.read.ReadBlocks";
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mifare_2fplus_2fread_2eproto);
    return ::descriptor_table_mifare_2fplus_2fread_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:mifare.plus.read.ReadBlocks)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_mifare_2fplus_2fread_2eproto;
};
// -------------------------------------------------------------------

class Blocks :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mifare.plus.read.Blocks) */ {
 public:
  Blocks();
  virtual ~Blocks();
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "mifare.plus.read.Blocks";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:mifare.plus.read.Blocks)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ReadBlocks::start_block() const {
  // @@protoc_insertion_point(field_get:mifare.plus.read.ReadBlocks.start_block)
...
inline void ReadBlocks::set_start_block(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:mifare.plus.read.ReadBlocks.start_block)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ReadBlocks::block_count() const {
  // @@protoc_insertion_point(field_get:mifare.plus.read.ReadBlocks.block_count)
...
inline void ReadBlocks::set_block_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:mifare.plus.read.ReadBlocks.block_count)
}
...
inline const std::string& Blocks::data() const {
  // @@protoc_insertion_point(field_get:mifare.plus.read.Blocks.data)
  return _internal_data();
}
inline void Blocks::set_data(const std::string& value) {
  _internal_set_data(value);
  // @@protoc_insertion_point(field_set:mifare.plus.read.Blocks.data)
}
inline std::string* Blocks::mutable_data() {
  // @@protoc_insertion_point(field_mutable:mifare.plus.read.Blocks.data)
...
inline void Blocks::set_data(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:mifare.plus.read.Blocks.data)
}
inline void Blocks::set_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mifare.plus.read.Blocks.data)
}
inline void Blocks::set_data(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mifare.plus.read.Blocks.data)
}
...
inline std::string* Blocks::release_data() {
  // @@protoc_insertion_point(field_release:mifare.plus.read.Blocks.data)
...
inline void Blocks::set_allocated_data(std::string* data) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mifare.plus.read.Blocks.data)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_mifare_2fplus_2fread_2eproto
