...
#include "sri512/read.pb.h"
#include "sri512/write.pb.h"
...
#include "cipurse/append_record.pb.h"
...
extern CipurseDefaultTypeInternal _Cipurse_default_instance_;
class Complex;
...
extern ContactLevel2DefaultTypeInternal _ContactLevel2_default_instance_;
...
extern NtagCardDefaultTypeInternal _NtagCard_default_instance_;
class PinPad;
class PinPadDefaultTypeInternal;
extern PinPadDefaultTypeInternal _PinPad_default_instance_;
class QrCode;
...
extern StmCardDefaultTypeInternal _StmCard_default_instance_;
class Touchscreen;
class TouchscreenDefaultTypeInternal;
extern TouchscreenDefaultTypeInternal _Touchscreen_default_instance_;
class TroikaCard;
class TroikaCardDefaultTypeInternal;
extern TroikaCardDefaultTypeInternal _TroikaCard_default_instance_;
class Turnstile;
class TurnstileDefaultTypeInternal;
extern TurnstileDefaultTypeInternal _Turnstile_default_instance_;
PROTOBUF_NAMESPACE_OPEN
template<> ::Cipurse* Arena::CreateMaybeMessage<::Cipurse>(Arena*);
template<> ::Complex* Arena::CreateMaybeMessage<::Complex>(Arena*);
template<> ::ContactLevel1* Arena::CreateMaybeMessage<::ContactLevel1>(Arena*);
template<> ::ContactLevel2* Arena::CreateMaybeMessage<::ContactLevel2>(Arena*);
...
template<> ::NtagCard* Arena::CreateMaybeMessage<::NtagCard>(Arena*);
template<> ::PinPad* Arena::CreateMaybeMessage<::PinPad>(Arena*);
template<> ::QrCode* Arena::CreateMaybeMessage<::QrCode>(Arena*);
template<> ::Service* Arena::CreateMaybeMessage<::Service>(Arena*);
template<> ::StmCard* Arena::CreateMaybeMessage<::StmCard>(Arena*);
template<> ::Touchscreen* Arena::CreateMaybeMessage<::Touchscreen>(Arena*);
template<> ::TroikaCard* Arena::CreateMaybeMessage<::TroikaCard>(Arena*);
template<> ::Turnstile* Arena::CreateMaybeMessage<::Turnstile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class PinPad :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PinPad) */ {
 public:
  PinPad();
  virtual ~PinPad();

  PinPad(const PinPad& from);
  PinPad(PinPad&& from) noexcept
    : PinPad() {
    *this = ::std::move(from);
  }

  inline PinPad& operator=(const PinPad& from) {
    CopyFrom(from);
    return *this;
  }
  inline PinPad& operator=(PinPad&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const PinPad& default_instance();

  enum PinpadCmdCase {
    kOnlinePin = 1,
    PINPAD_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const PinPad* internal_default_instance() {
    return reinterpret_cast<const PinPad*>(
               &_PinPad_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(PinPad& a, PinPad& b) {
    a.Swap(&b);
  }
  inline void Swap(PinPad* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline PinPad* New() const final {
    return CreateMaybeMessage<PinPad>(nullptr);
  }

  PinPad* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<PinPad>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const PinPad& from);
  void MergeFrom(const PinPad& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PinPad* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "PinPad";
  }
  ...
  enum : int {
    kOnlinePinFieldNumber = 1,
  };
  // optional .pinpad.online_pin.EnterOnlinePin online_pin = 1;
  bool has_online_pin() const;
  private:
  bool _internal_has_online_pin() const;
  public:
  void clear_online_pin();
  const ::pinpad::online_pin::EnterOnlinePin& online_pin() const;
  ::pinpad::online_pin::EnterOnlinePin* release_online_pin();
  ::pinpad::online_pin::EnterOnlinePin* mutable_online_pin();
  void set_allocated_online_pin(::pinpad::online_pin::EnterOnlinePin* online_pin);
  private:
  const ::pinpad::online_pin::EnterOnlinePin& _internal_online_pin() const;
  ::pinpad::online_pin::EnterOnlinePin* _internal_mutable_online_pin();
  public:

  void clear_pinpad_cmd();
  PinpadCmdCase pinpad_cmd_case() const;
  // @@protoc_insertion_point(class_scope:PinPad)
 private:
  class _Internal;
  void set_has_online_pin();

  inline bool has_pinpad_cmd() const;
  inline void clear_has_pinpad_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union PinpadCmdUnion {
    PinpadCmdUnion() {}
    ::pinpad::online_pin::EnterOnlinePin* online_pin_;
  } pinpad_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class ContactLevel2 :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ContactLevel2) */ {
 public:
  ContactLevel2();
  virtual ~ContactLevel2();

  ContactLevel2(const ContactLevel2& from);
  ContactLevel2(ContactLevel2&& from) noexcept
    : ContactLevel2() {
    *this = ::std::move(from);
  }

  inline ContactLevel2& operator=(const ContactLevel2& from) {
    CopyFrom(from);
    return *this;
  }
  inline ContactLevel2& operator=(ContactLevel2&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ContactLevel2& default_instance();

  enum ContactLevel2CmdCase {
    kPerformContactTransaction = 1,
    CONTACT_LEVEL2_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ContactLevel2* internal_default_instance() {
    return reinterpret_cast<const ContactLevel2*>(
               &_ContactLevel2_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(ContactLevel2& a, ContactLevel2& b) {
    a.Swap(&b);
  }
  inline void Swap(ContactLevel2* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline ContactLevel2* New() const final {
    return CreateMaybeMessage<ContactLevel2>(nullptr);
  }

  ContactLevel2* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ContactLevel2>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ContactLevel2& from);
  void MergeFrom(const ContactLevel2& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ContactLevel2* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ContactLevel2";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kPerformContactTransactionFieldNumber = 1,
  };
  // optional .contact.transaction.PerformTransaction perform_contact_transaction = 1;
  bool has_perform_contact_transaction() const;
  private:
  bool _internal_has_perform_contact_transaction() const;
  public:
  void clear_perform_contact_transaction();
  const ::contact::transaction::PerformTransaction& perform_contact_transaction() const;
  ::contact::transaction::PerformTransaction* release_perform_contact_transaction();
  ::contact::transaction::PerformTransaction* mutable_perform_contact_transaction();
  void set_allocated_perform_contact_transaction(::contact::transaction::PerformTransaction* perform_contact_transaction);
  private:
  const ::contact::transaction::PerformTransaction& _internal_perform_contact_transaction() const;
  ::contact::transaction::PerformTransaction* _internal_mutable_perform_contact_transaction();
  public:

  void clear_contact_level2_cmd();
  ContactLevel2CmdCase contact_level2_cmd_case() const;
  // @@protoc_insertion_point(class_scope:ContactLevel2)
 private:
  class _Internal;
  void set_has_perform_contact_transaction();

  inline bool has_contact_level2_cmd() const;
  inline void clear_has_contact_level2_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union ContactLevel2CmdUnion {
    ContactLevel2CmdUnion() {}
    ::contact::transaction::PerformTransaction* perform_contact_transaction_;
  } contact_level2_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class StmCard :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:StmCard) */ {
 public:
  StmCard();
  virtual ~StmCard();

  StmCard(const StmCard& from);
  StmCard(StmCard&& from) noexcept
    : StmCard() {
    *this = ::std::move(from);
  }

  inline StmCard& operator=(const StmCard& from) {
    CopyFrom(from);
    return *this;
  }
  inline StmCard& operator=(StmCard&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const StmCard& default_instance();

  enum StmcardCmdCase {
    kStmSri512ReadBlocks = 1,
    kStmSri512WriteBlocks = 2,
    STMCARD_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const StmCard* internal_default_instance() {
    return reinterpret_cast<const StmCard*>(
               &_StmCard_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(StmCard& a, StmCard& b) {
    a.Swap(&b);
  }
  inline void Swap(StmCard* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline StmCard* New() const final {
    return CreateMaybeMessage<StmCard>(nullptr);
  }

  StmCard* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<StmCard>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const StmCard& from);
  void MergeFrom(const StmCard& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StmCard* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "StmCard";
  }
  ...
  enum : int {
    kStmSri512ReadBlocksFieldNumber = 1,
    kStmSri512WriteBlocksFieldNumber = 2,
  };
  // optional .stmcard.sri512.read.ReadBlocks stm_sri512_read_blocks = 1;
  bool has_stm_sri512_read_blocks() const;
  private:
  bool _internal_has_stm_sri512_read_blocks() const;
  public:
  void clear_stm_sri512_read_blocks();
  const ::stmcard::sri512::read::ReadBlocks& stm_sri512_read_blocks() const;
  ::stmcard::sri512::read::ReadBlocks* release_stm_sri512_read_blocks();
  ::stmcard::sri512::read::ReadBlocks* mutable_stm_sri512_read_blocks();
  void set_allocated_stm_sri512_read_blocks(::stmcard::sri512::read::ReadBlocks* stm_sri512_read_blocks);
  private:
  const ::stmcard::sri512::read::ReadBlocks& _internal_stm_sri512_read_blocks() const;
  ::stmcard::sri512::read::ReadBlocks* _internal_mutable_stm_sri512_read_blocks();
  public:

  // optional .stmcard.sri512.write.WriteBlocks stm_sri512_write_blocks = 2;
  bool has_stm_sri512_write_blocks() const;
  private:
  bool _internal_has_stm_sri512_write_blocks() const;
  public:
  void clear_stm_sri512_write_blocks();
  const ::stmcard::sri512::write::WriteBlocks& stm_sri512_write_blocks() const;
  ::stmcard::sri512::write::WriteBlocks* release_stm_sri512_write_blocks();
  ::stmcard::sri512::write::WriteBlocks* mutable_stm_sri512_write_blocks();
  void set_allocated_stm_sri512_write_blocks(::stmcard::sri512::write::WriteBlocks* stm_sri512_write_blocks);
  private:
  const ::stmcard::sri512::write::WriteBlocks& _internal_stm_sri512_write_blocks() const;
  ::stmcard::sri512::write::WriteBlocks* _internal_mutable_stm_sri512_write_blocks();
  public:

  void clear_stmcard_cmd();
  StmcardCmdCase stmcard_cmd_case() const;
  // @@protoc_insertion_point(class_scope:StmCard)
 private:
  class _Internal;
  void set_has_stm_sri512_read_blocks();
  void set_has_stm_sri512_write_blocks();

  inline bool has_stmcard_cmd() const;
  inline void clear_has_stmcard_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union StmcardCmdUnion {
    StmcardCmdUnion() {}
    ::stmcard::sri512::read::ReadBlocks* stm_sri512_read_blocks_;
    ::stmcard::sri512::write::WriteBlocks* stm_sri512_write_blocks_;
  } stmcard_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class NtagCard :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:NtagCard) */ {
 public:
  NtagCard();
  virtual ~NtagCard();

  NtagCard(const NtagCard& from);
  NtagCard(NtagCard&& from) noexcept
    : NtagCard() {
    *this = ::std::move(from);
  }

  inline NtagCard& operator=(const NtagCard& from) {
    CopyFrom(from);
    return *this;
  }
  inline NtagCard& operator=(NtagCard&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const NtagCard& default_instance();

  enum NtagcardCmdCase {
    kNtagSelectFile = 1,
    kNtagAuthOnClearKey = 2,
    kNtagReadFile = 3,
    kNtagWriteFile = 4,
    NTAGCARD_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const NtagCard* internal_default_instance() {
    return reinterpret_cast<const NtagCard*>(
               &_NtagCard_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(NtagCard& a, NtagCard& b) {
    a.Swap(&b);
  }
  inline void Swap(NtagCard* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline NtagCard* New() const final {
    return CreateMaybeMessage<NtagCard>(nullptr);
  }

  NtagCard* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NtagCard>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const NtagCard& from);
  void MergeFrom(const NtagCard& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NtagCard* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "NtagCard";
  }
  ...
  enum : int {
    kNtagSelectFileFieldNumber = 1,
    kNtagAuthOnClearKeyFieldNumber = 2,
    kNtagReadFileFieldNumber = 3,
    kNtagWriteFileFieldNumber = 4,
  };
  // optional .ntag.select.SelectFile ntag_select_file = 1;
  bool has_ntag_select_file() const;
  private:
  bool _internal_has_ntag_select_file() const;
  public:
  void clear_ntag_select_file();
  const ::ntag::select::SelectFile& ntag_select_file() const;
  ::ntag::select::SelectFile* release_ntag_select_file();
  ::ntag::select::SelectFile* mutable_ntag_select_file();
  void set_allocated_ntag_select_file(::ntag::select::SelectFile* ntag_select_file);
  private:
  const ::ntag::select::SelectFile& _internal_ntag_select_file() const;
  ::ntag::select::SelectFile* _internal_mutable_ntag_select_file();
  public:

  // optional .ntag.auth.ClearKey ntag_auth_on_clear_key = 2;
  bool has_ntag_auth_on_clear_key() const;
  private:
  bool _internal_has_ntag_auth_on_clear_key() const;
  public:
  void clear_ntag_auth_on_clear_key();
  const ::ntag::auth::ClearKey& ntag_auth_on_clear_key() const;
  ::ntag::auth::ClearKey* release_ntag_auth_on_clear_key();
  ::ntag::auth::ClearKey* mutable_ntag_auth_on_clear_key();
  void set_allocated_ntag_auth_on_clear_key(::ntag::auth::ClearKey* ntag_auth_on_clear_key);
  private:
  const ::ntag::auth::ClearKey& _internal_ntag_auth_on_clear_key() const;
  ::ntag::auth::ClearKey* _internal_mutable_ntag_auth_on_clear_key();
  public:

  // optional .ntag.read.ReadFile ntag_read_file = 3;
  bool has_ntag_read_file() const;
  private:
  bool _internal_has_ntag_read_file() const;
  public:
  void clear_ntag_read_file();
  const ::ntag::read::ReadFile& ntag_read_file() const;
  ::ntag::read::ReadFile* release_ntag_read_file();
  ::ntag::read::ReadFile* mutable_ntag_read_file();
  void set_allocated_ntag_read_file(::ntag::read::ReadFile* ntag_read_file);
  private:
  const ::ntag::read::ReadFile& _internal_ntag_read_file() const;
  ::ntag::read::ReadFile* _internal_mutable_ntag_read_file();
  public:

  // optional .ntag.write.WriteFile ntag_write_file = 4;
  bool has_ntag_write_file() const;
  private:
  bool _internal_has_ntag_write_file() const;
  public:
  void clear_ntag_write_file();
  const ::ntag::write::WriteFile& ntag_write_file() const;
  ::ntag::write::WriteFile* release_ntag_write_file();
  ::ntag::write::WriteFile* mutable_ntag_write_file();
  void set_allocated_ntag_write_file(::ntag::write::WriteFile* ntag_write_file);
  private:
  const ::ntag::write::WriteFile& _internal_ntag_write_file() const;
  ::ntag::write::WriteFile* _internal_mutable_ntag_write_file();
  public:

  void clear_ntagcard_cmd();
  NtagcardCmdCase ntagcard_cmd_case() const;
  // @@protoc_insertion_point(class_scope:NtagCard)
 private:
  class _Internal;
  void set_has_ntag_select_file();
  void set_has_ntag_auth_on_clear_key();
  void set_has_ntag_read_file();
  void set_has_ntag_write_file();

  inline bool has_ntagcard_cmd() const;
  inline void clear_has_ntagcard_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union NtagcardCmdUnion {
    NtagcardCmdUnion() {}
    ::ntag::select::SelectFile* ntag_select_file_;
    ::ntag::auth::ClearKey* ntag_auth_on_clear_key_;
    ::ntag::read::ReadFile* ntag_read_file_;
    ::ntag::write::WriteFile* ntag_write_file_;
  } ntagcard_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class Touchscreen :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Touchscreen) */ {
 public:
  Touchscreen();
  virtual ~Touchscreen();

  Touchscreen(const Touchscreen& from);
  Touchscreen(Touchscreen&& from) noexcept
    : Touchscreen() {
    *this = ::std::move(from);
  }

  inline Touchscreen& operator=(const Touchscreen& from) {
    CopyFrom(from);
    return *this;
  }
  inline Touchscreen& operator=(Touchscreen&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Touchscreen& default_instance();

  enum TouchscreenCmdCase {
    kPollTouchscreen = 1,
    TOUCHSCREEN_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Touchscreen* internal_default_instance() {
    return reinterpret_cast<const Touchscreen*>(
               &_Touchscreen_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(Touchscreen& a, Touchscreen& b) {
    a.Swap(&b);
  }
  inline void Swap(Touchscreen* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Touchscreen* New() const final {
    return CreateMaybeMessage<Touchscreen>(nullptr);
  }

  Touchscreen* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Touchscreen>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Touchscreen& from);
  void MergeFrom(const Touchscreen& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Touchscreen* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Touchscreen";
  }
  ...
  void clear_touchscreen_cmd();
  TouchscreenCmdCase touchscreen_cmd_case() const;
  // @@protoc_insertion_point(class_scope:Touchscreen)
 private:
  class _Internal;
  void set_has_poll_touchscreen();

  inline bool has_touchscreen_cmd() const;
  inline void clear_has_touchscreen_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union TouchscreenCmdUnion {
    TouchscreenCmdUnion() {}
...
class Complex :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Complex) */ {
 public:
  Complex();
  virtual ~Complex();
  ...
  enum : int {
    kPollForEventFieldNumber = 1,
  };
  // optional .complex.poll.PollForEvent poll_for_event = 1;
  bool has_poll_for_event() const;
  private:
  bool _internal_has_poll_for_event() const;
  public:
  void clear_poll_for_event();
  const ::complex::poll::PollForEvent& poll_for_event() const;
  ::complex::poll::PollForEvent* release_poll_for_event();
  ::complex::poll::PollForEvent* mutable_poll_for_event();
  void set_allocated_poll_for_event(::complex::poll::PollForEvent* poll_for_event);
  private:
  const ::complex::poll::PollForEvent& _internal_poll_for_event() const;
  ::complex::poll::PollForEvent* _internal_mutable_poll_for_event();
  public:

  void clear_complex_cmd();
  ComplexCmdCase complex_cmd_case() const;
  // @@protoc_insertion_point(class_scope:Complex)
 private:
  class _Internal;
  void set_has_poll_for_event();

  inline bool has_complex_cmd() const;
  inline void clear_has_complex_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union ComplexCmdUnion {
    ComplexCmdUnion() {}
    ::complex::poll::PollForEvent* poll_for_event_;
  } complex_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class QrCode :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:QrCode) */ {
 public:
  QrCode();
  virtual ~QrCode();
  ...
  const ::qrcode::exchange::SendCommand& send_command() const;
  ::qrcode::exchange::SendCommand* release_send_command();
  ::qrcode::exchange::SendCommand* mutable_send_command();
  void set_allocated_send_command(::qrcode::exchange::SendCommand* send_command);
  private:
  const ::qrcode::exchange::SendCommand& _internal_send_command() const;
  ::qrcode::exchange::SendCommand* _internal_mutable_send_command();
  public:

  void clear_qrcode_cmd();
  QrcodeCmdCase qrcode_cmd_case() const;
  // @@protoc_insertion_point(class_scope:QrCode)
 private:
  class _Internal;
  void set_has_poll_for_qrcode();
  void set_has_send_command();

  inline bool has_qrcode_cmd() const;
  inline void clear_has_qrcode_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union QrcodeCmdUnion {
    QrcodeCmdUnion() {}
    ::qrcode::poll::PollForQrCode* poll_for_qrcode_;
    ::qrcode::exchange::SendCommand* send_command_;
  } qrcode_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class Cipurse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Cipurse) */ {
 public:
  Cipurse();
  virtual ~Cipurse();

  Cipurse(const Cipurse& from);
  Cipurse(Cipurse&& from) noexcept
    : Cipurse() {
    *this = ::std::move(from);
  }

  inline Cipurse& operator=(const Cipurse& from) {
    CopyFrom(from);
    return *this;
  }
  inline Cipurse& operator=(Cipurse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Cipurse& default_instance();

  enum CipurseCmdCase {
    kAuthorizeSam = 1,
    kSelectFile = 2,
    kEstablishSecureChannel = 3,
    kReadBinary = 4,
    kUpdateBinary = 5,
    kReadRecord = 6,
    kUpdateRecord = 7,
    ...
    kReadValue = 9,
    kModifyValue = 10,
    CIPURSE_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Cipurse* internal_default_instance() {
    return reinterpret_cast<const Cipurse*>(
               &_Cipurse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  friend void swap(Cipurse& a, Cipurse& b) {
    a.Swap(&b);
  }
  inline void Swap(Cipurse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Cipurse* New() const final {
    return CreateMaybeMessage<Cipurse>(nullptr);
  }

  Cipurse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Cipurse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Cipurse& from);
  void MergeFrom(const Cipurse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Cipurse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Cipurse";
  }
  ...
  enum : int {
    kAuthorizeSamFieldNumber = 1,
    kSelectFileFieldNumber = 2,
    kEstablishSecureChannelFieldNumber = 3,
    kReadBinaryFieldNumber = 4,
    kUpdateBinaryFieldNumber = 5,
    kReadRecordFieldNumber = 6,
    kUpdateRecordFieldNumber = 7,
    kAppendRecordFieldNumber = 8,
    kReadValueFieldNumber = 9,
    kModifyValueFieldNumber = 10,
  };
  // optional .cipurse.sam.AuthorizeHwSam authorize_sam = 1;
  bool has_authorize_sam() const;
  private:
  bool _internal_has_authorize_sam() const;
  public:
  void clear_authorize_sam();
  const ::cipurse::sam::AuthorizeHwSam& authorize_sam() const;
  ::cipurse::sam::AuthorizeHwSam* release_authorize_sam();
  ::cipurse::sam::AuthorizeHwSam* mutable_authorize_sam();
  void set_allocated_authorize_sam(::cipurse::sam::AuthorizeHwSam* authorize_sam);
  private:
  const ::cipurse::sam::AuthorizeHwSam& _internal_authorize_sam() const;
  ::cipurse::sam::AuthorizeHwSam* _internal_mutable_authorize_sam();
  public:

  // optional .cipurse.select.SelectFile select_file = 2;
  bool has_select_file() const;
  private:
  bool _internal_has_select_file() const;
  public:
  void clear_select_file();
  const ::cipurse::select::SelectFile& select_file() const;
  ::cipurse::select::SelectFile* release_select_file();
  ::cipurse::select::SelectFile* mutable_select_file();
  void set_allocated_select_file(::cipurse::select::SelectFile* select_file);
  private:
  const ::cipurse::select::SelectFile& _internal_select_file() const;
  ::cipurse::select::SelectFile* _internal_mutable_select_file();
  public:

  // optional .cipurse.auth.EstablishSecureChannel establish_secure_channel = 3;
  bool has_establish_secure_channel() const;
  private:
  bool _internal_has_establish_secure_channel() const;
  public:
  void clear_establish_secure_channel();
  const ::cipurse::auth::EstablishSecureChannel& establish_secure_channel() const;
  ::cipurse::auth::EstablishSecureChannel* release_establish_secure_channel();
  ::cipurse::auth::EstablishSecureChannel* mutable_establish_secure_channel();
  void set_allocated_establish_secure_channel(::cipurse::auth::EstablishSecureChannel* establish_secure_channel);
  private:
  const ::cipurse::auth::EstablishSecureChannel& _internal_establish_secure_channel() const;
  ::cipurse::auth::EstablishSecureChannel* _internal_mutable_establish_secure_channel();
  public:

  // optional .cipurse.read_binary.ReadBinary read_binary = 4;
  bool has_read_binary() const;
  private:
  bool _internal_has_read_binary() const;
  public:
  void clear_read_binary();
  const ::cipurse::read_binary::ReadBinary& read_binary() const;
  ::cipurse::read_binary::ReadBinary* release_read_binary();
  ::cipurse::read_binary::ReadBinary* mutable_read_binary();
  void set_allocated_read_binary(::cipurse::read_binary::ReadBinary* read_binary);
  private:
  const ::cipurse::read_binary::ReadBinary& _internal_read_binary() const;
  ::cipurse::read_binary::ReadBinary* _internal_mutable_read_binary();
  public:

  // optional .cipurse.update_binary.UpdateBinary update_binary = 5;
  bool has_update_binary() const;
  private:
  bool _internal_has_update_binary() const;
  public:
  void clear_update_binary();
  const ::cipurse::update_binary::UpdateBinary& update_binary() const;
  ::cipurse::update_binary::UpdateBinary* release_update_binary();
  ::cipurse::update_binary::UpdateBinary* mutable_update_binary();
  void set_allocated_update_binary(::cipurse::update_binary::UpdateBinary* update_binary);
  private:
  const ::cipurse::update_binary::UpdateBinary& _internal_update_binary() const;
  ::cipurse::update_binary::UpdateBinary* _internal_mutable_update_binary();
  public:

  // optional .cipurse.read_record.ReadRecord read_record = 6;
  bool has_read_record() const;
  private:
  bool _internal_has_read_record() const;
  public:
  void clear_read_record();
  const ::cipurse::read_record::ReadRecord& read_record() const;
  ::cipurse::read_record::ReadRecord* release_read_record();
  ::cipurse::read_record::ReadRecord* mutable_read_record();
  void set_allocated_read_record(::cipurse::read_record::ReadRecord* read_record);
  private:
  const ::cipurse::read_record::ReadRecord& _internal_read_record() const;
  ::cipurse::read_record::ReadRecord* _internal_mutable_read_record();
  public:

  // optional .cipurse.update_record.UpdateRecord update_record = 7;
  bool has_update_record() const;
  private:
  bool _internal_has_update_record() const;
  public:
  void clear_update_record();
  const ::cipurse::update_record::UpdateRecord& update_record() const;
  ::cipurse::update_record::UpdateRecord* release_update_record();
  ::cipurse::update_record::UpdateRecord* mutable_update_record();
  void set_allocated_update_record(::cipurse::update_record::UpdateRecord* update_record);
  private:
  const ::cipurse::update_record::UpdateRecord& _internal_update_record() const;
  ::cipurse::update_record::UpdateRecord* _internal_mutable_update_record();
  public:

  // optional .cipurse.append_record.AppendRecord append_record = 8;
  bool has_append_record() const;
  private:
  bool _internal_has_append_record() const;
  public:
  void clear_append_record();
  const ::cipurse::append_record::AppendRecord& append_record() const;
  ::cipurse::append_record::AppendRecord* release_append_record();
  ::cipurse::append_record::AppendRecord* mutable_append_record();
  void set_allocated_append_record(::cipurse::append_record::AppendRecord* append_record);
  private:
  const ::cipurse::append_record::AppendRecord& _internal_append_record() const;
  ::cipurse::append_record::AppendRecord* _internal_mutable_append_record();
  public:

  // optional .cipurse.read_value.ReadValue read_value = 9;
  bool has_read_value() const;
  private:
  bool _internal_has_read_value() const;
  public:
  void clear_read_value();
  const ::cipurse::read_value::ReadValue& read_value() const;
  ::cipurse::read_value::ReadValue* release_read_value();
  ::cipurse::read_value::ReadValue* mutable_read_value();
  void set_allocated_read_value(::cipurse::read_value::ReadValue* read_value);
  private:
  const ::cipurse::read_value::ReadValue& _internal_read_value() const;
  ::cipurse::read_value::ReadValue* _internal_mutable_read_value();
  public:

  // optional .cipurse.modify_value.ModifyValue modify_value = 10;
  bool has_modify_value() const;
  private:
  bool _internal_has_modify_value() const;
  public:
  void clear_modify_value();
  const ::cipurse::modify_value::ModifyValue& modify_value() const;
  ::cipurse::modify_value::ModifyValue* release_modify_value();
  ::cipurse::modify_value::ModifyValue* mutable_modify_value();
  void set_allocated_modify_value(::cipurse::modify_value::ModifyValue* modify_value);
  private:
  const ::cipurse::modify_value::ModifyValue& _internal_modify_value() const;
  ::cipurse::modify_value::ModifyValue* _internal_mutable_modify_value();
  public:

  void clear_cipurse_cmd();
  CipurseCmdCase cipurse_cmd_case() const;
  // @@protoc_insertion_point(class_scope:Cipurse)
 private:
  class _Internal;
  void set_has_authorize_sam();
  void set_has_select_file();
  void set_has_establish_secure_channel();
  void set_has_read_binary();
  void set_has_update_binary();
  void set_has_read_record();
  void set_has_update_record();
  void set_has_append_record();
  void set_has_read_value();
  void set_has_modify_value();

  inline bool has_cipurse_cmd() const;
  inline void clear_has_cipurse_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union CipurseCmdUnion {
    CipurseCmdUnion() {}
    ::cipurse::sam::AuthorizeHwSam* authorize_sam_;
    ::cipurse::select::SelectFile* select_file_;
    ::cipurse::auth::EstablishSecureChannel* establish_secure_channel_;
    ::cipurse::read_binary::ReadBinary* read_binary_;
    ::cipurse::update_binary::UpdateBinary* update_binary_;
    ::cipurse::read_record::ReadRecord* read_record_;
    ::cipurse::update_record::UpdateRecord* update_record_;
    ::cipurse::append_record::AppendRecord* append_record_;
    ::cipurse::read_value::ReadValue* read_value_;
    ::cipurse::modify_value::ModifyValue* modify_value_;
  } cipurse_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class Turnstile :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Turnstile) */ {
 public:
  Turnstile();
  virtual ~Turnstile();

  Turnstile(const Turnstile& from);
  Turnstile(Turnstile&& from) noexcept
    : Turnstile() {
    *this = ::std::move(from);
  }

  inline Turnstile& operator=(const Turnstile& from) {
    CopyFrom(from);
    return *this;
  }
  inline Turnstile& operator=(Turnstile&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Turnstile& default_instance();

  enum TurnstileCmdCase {
    kAllowOnePass = 1,
    TURNSTILE_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Turnstile* internal_default_instance() {
    return reinterpret_cast<const Turnstile*>(
               &_Turnstile_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    15;

  friend void swap(Turnstile& a, Turnstile& b) {
    a.Swap(&b);
  }
  inline void Swap(Turnstile* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Turnstile* New() const final {
    return CreateMaybeMessage<Turnstile>(nullptr);
  }

  Turnstile* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Turnstile>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Turnstile& from);
  void MergeFrom(const Turnstile& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Turnstile* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Turnstile";
  }
  ...
  enum : int {
    kAllowOnePassFieldNumber = 1,
  };
  // optional .turnstile.passage.AllowOnePass allow_one_pass = 1;
  bool has_allow_one_pass() const;
  private:
  bool _internal_has_allow_one_pass() const;
  public:
  void clear_allow_one_pass();
  const ::turnstile::passage::AllowOnePass& allow_one_pass() const;
  ::turnstile::passage::AllowOnePass* release_allow_one_pass();
  ::turnstile::passage::AllowOnePass* mutable_allow_one_pass();
  void set_allocated_allow_one_pass(::turnstile::passage::AllowOnePass* allow_one_pass);
  private:
  const ::turnstile::passage::AllowOnePass& _internal_allow_one_pass() const;
  ::turnstile::passage::AllowOnePass* _internal_mutable_allow_one_pass();
  public:

  void clear_turnstile_cmd();
  TurnstileCmdCase turnstile_cmd_case() const;
  // @@protoc_insertion_point(class_scope:Turnstile)
 private:
  class _Internal;
  void set_has_allow_one_pass();

  inline bool has_turnstile_cmd() const;
  inline void clear_has_turnstile_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union TurnstileCmdUnion {
    TurnstileCmdUnion() {}
    ::turnstile::passage::AllowOnePass* allow_one_pass_;
  } turnstile_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class TroikaCard :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:TroikaCard) */ {
 public:
  TroikaCard();
  virtual ~TroikaCard();

  TroikaCard(const TroikaCard& from);
  TroikaCard(TroikaCard&& from) noexcept
    : TroikaCard() {
    *this = ::std::move(from);
  }

  inline TroikaCard& operator=(const TroikaCard& from) {
    CopyFrom(from);
    return *this;
  }
  inline TroikaCard& operator=(TroikaCard&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const TroikaCard& default_instance();

  enum TroikaCmdCase {
    kTroikaAv3ReadTicket = 1,
    kTroikaAv3WriteTicket = 2,
    TROIKA_CMD_NOT_SET = 0,
  };

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const TroikaCard* internal_default_instance() {
    return reinterpret_cast<const TroikaCard*>(
               &_TroikaCard_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    17;

  friend void swap(TroikaCard& a, TroikaCard& b) {
    a.Swap(&b);
  }
  inline void Swap(TroikaCard* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline TroikaCard* New() const final {
    return CreateMaybeMessage<TroikaCard>(nullptr);
  }

  TroikaCard* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TroikaCard>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const TroikaCard& from);
  void MergeFrom(const TroikaCard& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(TroikaCard* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "TroikaCard";
  }
  ...
  enum : int {
    ...
    kTroikaAv3WriteTicketFieldNumber = 2,
  };
  ...
  bool has_troika_av3_write_ticket() const;
  private:
  bool _internal_has_troika_av3_write_ticket() const;
  public:
  void clear_troika_av3_write_ticket();
  const ::troika::av3::write_ticket::WriteTicket& troika_av3_write_ticket() const;
  ::troika::av3::write_ticket::WriteTicket* release_troika_av3_write_ticket();
  ::troika::av3::write_ticket::WriteTicket* mutable_troika_av3_write_ticket();
  void set_allocated_troika_av3_write_ticket(::troika::av3::write_ticket::WriteTicket* troika_av3_write_ticket);
  private:
  const ::troika::av3::write_ticket::WriteTicket& _internal_troika_av3_write_ticket() const;
  ::troika::av3::write_ticket::WriteTicket* _internal_mutable_troika_av3_write_ticket();
  public:

  void clear_troika_cmd();
  TroikaCmdCase troika_cmd_case() const;
  // @@protoc_insertion_point(class_scope:TroikaCard)
 private:
  class _Internal;
  void set_has_troika_av3_read_ticket();
  void set_has_troika_av3_write_ticket();

  inline bool has_troika_cmd() const;
  inline void clear_has_troika_cmd();

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  union TroikaCmdUnion {
    TroikaCmdUnion() {}
    ::troika::av3::read_ticket::ReadTicket* troika_av3_read_ticket_;
    ::troika::av3::write_ticket::WriteTicket* troika_av3_write_ticket_;
  } troika_cmd_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
// optional .pinpad.online_pin.EnterOnlinePin online_pin = 1;
inline bool PinPad::_internal_has_online_pin() const {
  return pinpad_cmd_case() == kOnlinePin;
}
inline bool PinPad::has_online_pin() const {
  return _internal_has_online_pin();
}
inline void PinPad::set_has_online_pin() {
  _oneof_case_[0] = kOnlinePin;
}
inline ::pinpad::online_pin::EnterOnlinePin* PinPad::release_online_pin() {
  // @@protoc_insertion_point(field_release:PinPad.online_pin)
  if (_internal_has_online_pin()) {
    clear_has_pinpad_cmd();
      ::pinpad::online_pin::EnterOnlinePin* temp = pinpad_cmd_.online_pin_;
    pinpad_cmd_.online_pin_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::pinpad::online_pin::EnterOnlinePin& PinPad::_internal_online_pin() const {
  return _internal_has_online_pin()
      ? *pinpad_cmd_.online_pin_
      : *reinterpret_cast< ::pinpad::online_pin::EnterOnlinePin*>(&::pinpad::online_pin::_EnterOnlinePin_default_instance_);
}
inline const ::pinpad::online_pin::EnterOnlinePin& PinPad::online_pin() const {
  // @@protoc_insertion_point(field_get:PinPad.online_pin)
  return _internal_online_pin();
}
inline ::pinpad::online_pin::EnterOnlinePin* PinPad::_internal_mutable_online_pin() {
  if (!_internal_has_online_pin()) {
    clear_pinpad_cmd();
    set_has_online_pin();
    pinpad_cmd_.online_pin_ = CreateMaybeMessage< ::pinpad::online_pin::EnterOnlinePin >(
        GetArenaNoVirtual());
  }
  return pinpad_cmd_.online_pin_;
}
inline ::pinpad::online_pin::EnterOnlinePin* PinPad::mutable_online_pin() {
  // @@protoc_insertion_point(field_mutable:PinPad.online_pin)
  return _internal_mutable_online_pin();
}

inline bool PinPad::has_pinpad_cmd() const {
  return pinpad_cmd_case() != PINPAD_CMD_NOT_SET;
}
inline void PinPad::clear_has_pinpad_cmd() {
  _oneof_case_[0] = PINPAD_CMD_NOT_SET;
}
inline PinPad::PinpadCmdCase PinPad::pinpad_cmd_case() const {
  return PinPad::PinpadCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .contact.transaction.PerformTransaction perform_contact_transaction = 1;
inline bool ContactLevel2::_internal_has_perform_contact_transaction() const {
  return contact_level2_cmd_case() == kPerformContactTransaction;
}
inline bool ContactLevel2::has_perform_contact_transaction() const {
  return _internal_has_perform_contact_transaction();
}
inline void ContactLevel2::set_has_perform_contact_transaction() {
  _oneof_case_[0] = kPerformContactTransaction;
}
inline ::contact::transaction::PerformTransaction* ContactLevel2::release_perform_contact_transaction() {
  // @@protoc_insertion_point(field_release:ContactLevel2.perform_contact_transaction)
  if (_internal_has_perform_contact_transaction()) {
    clear_has_contact_level2_cmd();
      ::contact::transaction::PerformTransaction* temp = contact_level2_cmd_.perform_contact_transaction_;
    contact_level2_cmd_.perform_contact_transaction_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::contact::transaction::PerformTransaction& ContactLevel2::_internal_perform_contact_transaction() const {
  return _internal_has_perform_contact_transaction()
      ? *contact_level2_cmd_.perform_contact_transaction_
      : *reinterpret_cast< ::contact::transaction::PerformTransaction*>(&::contact::transaction::_PerformTransaction_default_instance_);
}
inline const ::contact::transaction::PerformTransaction& ContactLevel2::perform_contact_transaction() const {
  // @@protoc_insertion_point(field_get:ContactLevel2.perform_contact_transaction)
  return _internal_perform_contact_transaction();
}
inline ::contact::transaction::PerformTransaction* ContactLevel2::_internal_mutable_perform_contact_transaction() {
  if (!_internal_has_perform_contact_transaction()) {
    clear_contact_level2_cmd();
    set_has_perform_contact_transaction();
    contact_level2_cmd_.perform_contact_transaction_ = CreateMaybeMessage< ::contact::transaction::PerformTransaction >(
        GetArenaNoVirtual());
  }
  return contact_level2_cmd_.perform_contact_transaction_;
}
inline ::contact::transaction::PerformTransaction* ContactLevel2::mutable_perform_contact_transaction() {
  // @@protoc_insertion_point(field_mutable:ContactLevel2.perform_contact_transaction)
  return _internal_mutable_perform_contact_transaction();
}

inline bool ContactLevel2::has_contact_level2_cmd() const {
  return contact_level2_cmd_case() != CONTACT_LEVEL2_CMD_NOT_SET;
}
inline void ContactLevel2::clear_has_contact_level2_cmd() {
  _oneof_case_[0] = CONTACT_LEVEL2_CMD_NOT_SET;
}
inline ContactLevel2::ContactLevel2CmdCase ContactLevel2::contact_level2_cmd_case() const {
  return ContactLevel2::ContactLevel2CmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .stmcard.sri512.read.ReadBlocks stm_sri512_read_blocks = 1;
inline bool StmCard::_internal_has_stm_sri512_read_blocks() const {
  return stmcard_cmd_case() == kStmSri512ReadBlocks;
}
inline bool StmCard::has_stm_sri512_read_blocks() const {
  return _internal_has_stm_sri512_read_blocks();
}
inline void StmCard::set_has_stm_sri512_read_blocks() {
  _oneof_case_[0] = kStmSri512ReadBlocks;
}
inline ::stmcard::sri512::read::ReadBlocks* StmCard::release_stm_sri512_read_blocks() {
  // @@protoc_insertion_point(field_release:StmCard.stm_sri512_read_blocks)
  if (_internal_has_stm_sri512_read_blocks()) {
    clear_has_stmcard_cmd();
      ::stmcard::sri512::read::ReadBlocks* temp = stmcard_cmd_.stm_sri512_read_blocks_;
    stmcard_cmd_.stm_sri512_read_blocks_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::stmcard::sri512::read::ReadBlocks& StmCard::_internal_stm_sri512_read_blocks() const {
  return _internal_has_stm_sri512_read_blocks()
      ? *stmcard_cmd_.stm_sri512_read_blocks_
      : *reinterpret_cast< ::stmcard::sri512::read::ReadBlocks*>(&::stmcard::sri512::read::_ReadBlocks_default_instance_);
}
inline const ::stmcard::sri512::read::ReadBlocks& StmCard::stm_sri512_read_blocks() const {
  // @@protoc_insertion_point(field_get:StmCard.stm_sri512_read_blocks)
  return _internal_stm_sri512_read_blocks();
}
inline ::stmcard::sri512::read::ReadBlocks* StmCard::_internal_mutable_stm_sri512_read_blocks() {
  if (!_internal_has_stm_sri512_read_blocks()) {
    clear_stmcard_cmd();
    set_has_stm_sri512_read_blocks();
    stmcard_cmd_.stm_sri512_read_blocks_ = CreateMaybeMessage< ::stmcard::sri512::read::ReadBlocks >(
        GetArenaNoVirtual());
  }
  return stmcard_cmd_.stm_sri512_read_blocks_;
}
inline ::stmcard::sri512::read::ReadBlocks* StmCard::mutable_stm_sri512_read_blocks() {
  // @@protoc_insertion_point(field_mutable:StmCard.stm_sri512_read_blocks)
  return _internal_mutable_stm_sri512_read_blocks();
}

// optional .stmcard.sri512.write.WriteBlocks stm_sri512_write_blocks = 2;
inline bool StmCard::_internal_has_stm_sri512_write_blocks() const {
  return stmcard_cmd_case() == kStmSri512WriteBlocks;
}
inline bool StmCard::has_stm_sri512_write_blocks() const {
  return _internal_has_stm_sri512_write_blocks();
}
inline void StmCard::set_has_stm_sri512_write_blocks() {
  _oneof_case_[0] = kStmSri512WriteBlocks;
}
inline ::stmcard::sri512::write::WriteBlocks* StmCard::release_stm_sri512_write_blocks() {
  // @@protoc_insertion_point(field_release:StmCard.stm_sri512_write_blocks)
  if (_internal_has_stm_sri512_write_blocks()) {
    clear_has_stmcard_cmd();
      ::stmcard::sri512::write::WriteBlocks* temp = stmcard_cmd_.stm_sri512_write_blocks_;
    stmcard_cmd_.stm_sri512_write_blocks_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::stmcard::sri512::write::WriteBlocks& StmCard::_internal_stm_sri512_write_blocks() const {
  return _internal_has_stm_sri512_write_blocks()
      ? *stmcard_cmd_.stm_sri512_write_blocks_
      : *reinterpret_cast< ::stmcard::sri512::write::WriteBlocks*>(&::stmcard::sri512::write::_WriteBlocks_default_instance_);
}
inline const ::stmcard::sri512::write::WriteBlocks& StmCard::stm_sri512_write_blocks() const {
  // @@protoc_insertion_point(field_get:StmCard.stm_sri512_write_blocks)
  return _internal_stm_sri512_write_blocks();
}
inline ::stmcard::sri512::write::WriteBlocks* StmCard::_internal_mutable_stm_sri512_write_blocks() {
  if (!_internal_has_stm_sri512_write_blocks()) {
    clear_stmcard_cmd();
    set_has_stm_sri512_write_blocks();
    stmcard_cmd_.stm_sri512_write_blocks_ = CreateMaybeMessage< ::stmcard::sri512::write::WriteBlocks >(
        GetArenaNoVirtual());
  }
  return stmcard_cmd_.stm_sri512_write_blocks_;
}
inline ::stmcard::sri512::write::WriteBlocks* StmCard::mutable_stm_sri512_write_blocks() {
  // @@protoc_insertion_point(field_mutable:StmCard.stm_sri512_write_blocks)
  return _internal_mutable_stm_sri512_write_blocks();
}

inline bool StmCard::has_stmcard_cmd() const {
  return stmcard_cmd_case() != STMCARD_CMD_NOT_SET;
}
inline void StmCard::clear_has_stmcard_cmd() {
  _oneof_case_[0] = STMCARD_CMD_NOT_SET;
}
inline StmCard::StmcardCmdCase StmCard::stmcard_cmd_case() const {
  return StmCard::StmcardCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .ntag.select.SelectFile ntag_select_file = 1;
inline bool NtagCard::_internal_has_ntag_select_file() const {
  return ntagcard_cmd_case() == kNtagSelectFile;
}
inline bool NtagCard::has_ntag_select_file() const {
  return _internal_has_ntag_select_file();
}
inline void NtagCard::set_has_ntag_select_file() {
  _oneof_case_[0] = kNtagSelectFile;
}
inline ::ntag::select::SelectFile* NtagCard::release_ntag_select_file() {
  // @@protoc_insertion_point(field_release:NtagCard.ntag_select_file)
  if (_internal_has_ntag_select_file()) {
    clear_has_ntagcard_cmd();
      ::ntag::select::SelectFile* temp = ntagcard_cmd_.ntag_select_file_;
    ntagcard_cmd_.ntag_select_file_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::ntag::select::SelectFile& NtagCard::_internal_ntag_select_file() const {
  return _internal_has_ntag_select_file()
      ? *ntagcard_cmd_.ntag_select_file_
      : *reinterpret_cast< ::ntag::select::SelectFile*>(&::ntag::select::_SelectFile_default_instance_);
}
inline const ::ntag::select::SelectFile& NtagCard::ntag_select_file() const {
  // @@protoc_insertion_point(field_get:NtagCard.ntag_select_file)
  return _internal_ntag_select_file();
}
inline ::ntag::select::SelectFile* NtagCard::_internal_mutable_ntag_select_file() {
  if (!_internal_has_ntag_select_file()) {
    clear_ntagcard_cmd();
    set_has_ntag_select_file();
    ntagcard_cmd_.ntag_select_file_ = CreateMaybeMessage< ::ntag::select::SelectFile >(
        GetArenaNoVirtual());
  }
  return ntagcard_cmd_.ntag_select_file_;
}
inline ::ntag::select::SelectFile* NtagCard::mutable_ntag_select_file() {
  // @@protoc_insertion_point(field_mutable:NtagCard.ntag_select_file)
  return _internal_mutable_ntag_select_file();
}

// optional .ntag.auth.ClearKey ntag_auth_on_clear_key = 2;
inline bool NtagCard::_internal_has_ntag_auth_on_clear_key() const {
  return ntagcard_cmd_case() == kNtagAuthOnClearKey;
}
inline bool NtagCard::has_ntag_auth_on_clear_key() const {
  return _internal_has_ntag_auth_on_clear_key();
}
inline void NtagCard::set_has_ntag_auth_on_clear_key() {
  _oneof_case_[0] = kNtagAuthOnClearKey;
}
inline ::ntag::auth::ClearKey* NtagCard::release_ntag_auth_on_clear_key() {
  // @@protoc_insertion_point(field_release:NtagCard.ntag_auth_on_clear_key)
  if (_internal_has_ntag_auth_on_clear_key()) {
    clear_has_ntagcard_cmd();
      ::ntag::auth::ClearKey* temp = ntagcard_cmd_.ntag_auth_on_clear_key_;
    ntagcard_cmd_.ntag_auth_on_clear_key_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::ntag::auth::ClearKey& NtagCard::_internal_ntag_auth_on_clear_key() const {
  return _internal_has_ntag_auth_on_clear_key()
      ? *ntagcard_cmd_.ntag_auth_on_clear_key_
      : *reinterpret_cast< ::ntag::auth::ClearKey*>(&::ntag::auth::_ClearKey_default_instance_);
}
inline const ::ntag::auth::ClearKey& NtagCard::ntag_auth_on_clear_key() const {
  // @@protoc_insertion_point(field_get:NtagCard.ntag_auth_on_clear_key)
  return _internal_ntag_auth_on_clear_key();
}
inline ::ntag::auth::ClearKey* NtagCard::_internal_mutable_ntag_auth_on_clear_key() {
  if (!_internal_has_ntag_auth_on_clear_key()) {
    clear_ntagcard_cmd();
    set_has_ntag_auth_on_clear_key();
    ntagcard_cmd_.ntag_auth_on_clear_key_ = CreateMaybeMessage< ::ntag::auth::ClearKey >(
        GetArenaNoVirtual());
  }
  return ntagcard_cmd_.ntag_auth_on_clear_key_;
}
inline ::ntag::auth::ClearKey* NtagCard::mutable_ntag_auth_on_clear_key() {
  // @@protoc_insertion_point(field_mutable:NtagCard.ntag_auth_on_clear_key)
  return _internal_mutable_ntag_auth_on_clear_key();
}

// optional .ntag.read.ReadFile ntag_read_file = 3;
inline bool NtagCard::_internal_has_ntag_read_file() const {
  return ntagcard_cmd_case() == kNtagReadFile;
}
inline bool NtagCard::has_ntag_read_file() const {
  return _internal_has_ntag_read_file();
}
inline void NtagCard::set_has_ntag_read_file() {
  _oneof_case_[0] = kNtagReadFile;
}
inline ::ntag::read::ReadFile* NtagCard::release_ntag_read_file() {
  // @@protoc_insertion_point(field_release:NtagCard.ntag_read_file)
  if (_internal_has_ntag_read_file()) {
    clear_has_ntagcard_cmd();
      ::ntag::read::ReadFile* temp = ntagcard_cmd_.ntag_read_file_;
    ntagcard_cmd_.ntag_read_file_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::ntag::read::ReadFile& NtagCard::_internal_ntag_read_file() const {
  return _internal_has_ntag_read_file()
      ? *ntagcard_cmd_.ntag_read_file_
      : *reinterpret_cast< ::ntag::read::ReadFile*>(&::ntag::read::_ReadFile_default_instance_);
}
inline const ::ntag::read::ReadFile& NtagCard::ntag_read_file() const {
  // @@protoc_insertion_point(field_get:NtagCard.ntag_read_file)
  return _internal_ntag_read_file();
}
inline ::ntag::read::ReadFile* NtagCard::_internal_mutable_ntag_read_file() {
  if (!_internal_has_ntag_read_file()) {
    clear_ntagcard_cmd();
    set_has_ntag_read_file();
    ntagcard_cmd_.ntag_read_file_ = CreateMaybeMessage< ::ntag::read::ReadFile >(
        GetArenaNoVirtual());
  }
  return ntagcard_cmd_.ntag_read_file_;
}
inline ::ntag::read::ReadFile* NtagCard::mutable_ntag_read_file() {
  // @@protoc_insertion_point(field_mutable:NtagCard.ntag_read_file)
  return _internal_mutable_ntag_read_file();
}

// optional .ntag.write.WriteFile ntag_write_file = 4;
inline bool NtagCard::_internal_has_ntag_write_file() const {
  return ntagcard_cmd_case() == kNtagWriteFile;
}
inline bool NtagCard::has_ntag_write_file() const {
  return _internal_has_ntag_write_file();
}
inline void NtagCard::set_has_ntag_write_file() {
  _oneof_case_[0] = kNtagWriteFile;
}
inline ::ntag::write::WriteFile* NtagCard::release_ntag_write_file() {
  // @@protoc_insertion_point(field_release:NtagCard.ntag_write_file)
  if (_internal_has_ntag_write_file()) {
    clear_has_ntagcard_cmd();
      ::ntag::write::WriteFile* temp = ntagcard_cmd_.ntag_write_file_;
    ntagcard_cmd_.ntag_write_file_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::ntag::write::WriteFile& NtagCard::_internal_ntag_write_file() const {
  return _internal_has_ntag_write_file()
      ? *ntagcard_cmd_.ntag_write_file_
      : *reinterpret_cast< ::ntag::write::WriteFile*>(&::ntag::write::_WriteFile_default_instance_);
}
inline const ::ntag::write::WriteFile& NtagCard::ntag_write_file() const {
  // @@protoc_insertion_point(field_get:NtagCard.ntag_write_file)
  return _internal_ntag_write_file();
}
inline ::ntag::write::WriteFile* NtagCard::_internal_mutable_ntag_write_file() {
  if (!_internal_has_ntag_write_file()) {
    clear_ntagcard_cmd();
    set_has_ntag_write_file();
    ntagcard_cmd_.ntag_write_file_ = CreateMaybeMessage< ::ntag::write::WriteFile >(
        GetArenaNoVirtual());
  }
  return ntagcard_cmd_.ntag_write_file_;
}
inline ::ntag::write::WriteFile* NtagCard::mutable_ntag_write_file() {
  // @@protoc_insertion_point(field_mutable:NtagCard.ntag_write_file)
  return _internal_mutable_ntag_write_file();
}

inline bool NtagCard::has_ntagcard_cmd() const {
  return ntagcard_cmd_case() != NTAGCARD_CMD_NOT_SET;
}
inline void NtagCard::clear_has_ntagcard_cmd() {
  _oneof_case_[0] = NTAGCARD_CMD_NOT_SET;
}
inline NtagCard::NtagcardCmdCase NtagCard::ntagcard_cmd_case() const {
  return NtagCard::NtagcardCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .touchscreen.poll.PollTouchscreen poll_touchscreen = 1;
inline bool Touchscreen::_internal_has_poll_touchscreen() const {
  return touchscreen_cmd_case() == kPollTouchscreen;
}
inline bool Touchscreen::has_poll_touchscreen() const {
  return _internal_has_poll_touchscreen();
}
inline void Touchscreen::set_has_poll_touchscreen() {
  _oneof_case_[0] = kPollTouchscreen;
}
inline ::touchscreen::poll::PollTouchscreen* Touchscreen::release_poll_touchscreen() {
  // @@protoc_insertion_point(field_release:Touchscreen.poll_touchscreen)
  if (_internal_has_poll_touchscreen()) {
    clear_has_touchscreen_cmd();
      ::touchscreen::poll::PollTouchscreen* temp = touchscreen_cmd_.poll_touchscreen_;
    touchscreen_cmd_.poll_touchscreen_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::touchscreen::poll::PollTouchscreen& Touchscreen::_internal_poll_touchscreen() const {
  return _internal_has_poll_touchscreen()
      ? *touchscreen_cmd_.poll_touchscreen_
      : *reinterpret_cast< ::touchscreen::poll::PollTouchscreen*>(&::touchscreen::poll::_PollTouchscreen_default_instance_);
}
inline const ::touchscreen::poll::PollTouchscreen& Touchscreen::poll_touchscreen() const {
  // @@protoc_insertion_point(field_get:Touchscreen.poll_touchscreen)
  return _internal_poll_touchscreen();
}
inline ::touchscreen::poll::PollTouchscreen* Touchscreen::_internal_mutable_poll_touchscreen() {
  if (!_internal_has_poll_touchscreen()) {
    clear_touchscreen_cmd();
    set_has_poll_touchscreen();
    touchscreen_cmd_.poll_touchscreen_ = CreateMaybeMessage< ::touchscreen::poll::PollTouchscreen >(
        GetArenaNoVirtual());
  }
  return touchscreen_cmd_.poll_touchscreen_;
}
inline ::touchscreen::poll::PollTouchscreen* Touchscreen::mutable_poll_touchscreen() {
  // @@protoc_insertion_point(field_mutable:Touchscreen.poll_touchscreen)
  return _internal_mutable_poll_touchscreen();
}

inline bool Touchscreen::has_touchscreen_cmd() const {
  return touchscreen_cmd_case() != TOUCHSCREEN_CMD_NOT_SET;
}
inline void Touchscreen::clear_has_touchscreen_cmd() {
  _oneof_case_[0] = TOUCHSCREEN_CMD_NOT_SET;
}
inline Touchscreen::TouchscreenCmdCase Touchscreen::touchscreen_cmd_case() const {
  return Touchscreen::TouchscreenCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .complex.poll.PollForEvent poll_for_event = 1;
inline bool Complex::_internal_has_poll_for_event() const {
  return complex_cmd_case() == kPollForEvent;
}
inline bool Complex::has_poll_for_event() const {
  return _internal_has_poll_for_event();
}
inline void Complex::set_has_poll_for_event() {
  _oneof_case_[0] = kPollForEvent;
}
inline ::complex::poll::PollForEvent* Complex::release_poll_for_event() {
  // @@protoc_insertion_point(field_release:Complex.poll_for_event)
  if (_internal_has_poll_for_event()) {
    clear_has_complex_cmd();
      ::complex::poll::PollForEvent* temp = complex_cmd_.poll_for_event_;
    complex_cmd_.poll_for_event_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::complex::poll::PollForEvent& Complex::_internal_poll_for_event() const {
  return _internal_has_poll_for_event()
      ? *complex_cmd_.poll_for_event_
      : *reinterpret_cast< ::complex::poll::PollForEvent*>(&::complex::poll::_PollForEvent_default_instance_);
}
inline const ::complex::poll::PollForEvent& Complex::poll_for_event() const {
  // @@protoc_insertion_point(field_get:Complex.poll_for_event)
  return _internal_poll_for_event();
}
inline ::complex::poll::PollForEvent* Complex::_internal_mutable_poll_for_event() {
  if (!_internal_has_poll_for_event()) {
    clear_complex_cmd();
    set_has_poll_for_event();
    complex_cmd_.poll_for_event_ = CreateMaybeMessage< ::complex::poll::PollForEvent >(
        GetArenaNoVirtual());
  }
  return complex_cmd_.poll_for_event_;
}
inline ::complex::poll::PollForEvent* Complex::mutable_poll_for_event() {
  // @@protoc_insertion_point(field_mutable:Complex.poll_for_event)
  return _internal_mutable_poll_for_event();
}

inline bool Complex::has_complex_cmd() const {
  return complex_cmd_case() != COMPLEX_CMD_NOT_SET;
}
inline void Complex::clear_has_complex_cmd() {
  _oneof_case_[0] = COMPLEX_CMD_NOT_SET;
}
inline Complex::ComplexCmdCase Complex::complex_cmd_case() const {
  return Complex::ComplexCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .qrcode.poll.PollForQrCode poll_for_qrcode = 1;
inline bool QrCode::_internal_has_poll_for_qrcode() const {
  return qrcode_cmd_case() == kPollForQrcode;
}
inline bool QrCode::has_poll_for_qrcode() const {
  return _internal_has_poll_for_qrcode();
}
inline void QrCode::set_has_poll_for_qrcode() {
  _oneof_case_[0] = kPollForQrcode;
}
inline ::qrcode::poll::PollForQrCode* QrCode::release_poll_for_qrcode() {
  // @@protoc_insertion_point(field_release:QrCode.poll_for_qrcode)
  if (_internal_has_poll_for_qrcode()) {
    clear_has_qrcode_cmd();
      ::qrcode::poll::PollForQrCode* temp = qrcode_cmd_.poll_for_qrcode_;
    qrcode_cmd_.poll_for_qrcode_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::qrcode::poll::PollForQrCode& QrCode::_internal_poll_for_qrcode() const {
  return _internal_has_poll_for_qrcode()
      ? *qrcode_cmd_.poll_for_qrcode_
      : *reinterpret_cast< ::qrcode::poll::PollForQrCode*>(&::qrcode::poll::_PollForQrCode_default_instance_);
}
inline const ::qrcode::poll::PollForQrCode& QrCode::poll_for_qrcode() const {
  // @@protoc_insertion_point(field_get:QrCode.poll_for_qrcode)
  return _internal_poll_for_qrcode();
}
inline ::qrcode::poll::PollForQrCode* QrCode::_internal_mutable_poll_for_qrcode() {
  if (!_internal_has_poll_for_qrcode()) {
    clear_qrcode_cmd();
    set_has_poll_for_qrcode();
    qrcode_cmd_.poll_for_qrcode_ = CreateMaybeMessage< ::qrcode::poll::PollForQrCode >(
        GetArenaNoVirtual());
  }
  return qrcode_cmd_.poll_for_qrcode_;
}
inline ::qrcode::poll::PollForQrCode* QrCode::mutable_poll_for_qrcode() {
  // @@protoc_insertion_point(field_mutable:QrCode.poll_for_qrcode)
  return _internal_mutable_poll_for_qrcode();
}

// optional .qrcode.exchange.SendCommand send_command = 2;
inline bool QrCode::_internal_has_send_command() const {
  return qrcode_cmd_case() == kSendCommand;
}
inline bool QrCode::has_send_command() const {
  return _internal_has_send_command();
}
inline void QrCode::set_has_send_command() {
  _oneof_case_[0] = kSendCommand;
}
inline ::qrcode::exchange::SendCommand* QrCode::release_send_command() {
  // @@protoc_insertion_point(field_release:QrCode.send_command)
  if (_internal_has_send_command()) {
    clear_has_qrcode_cmd();
      ::qrcode::exchange::SendCommand* temp = qrcode_cmd_.send_command_;
    qrcode_cmd_.send_command_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::qrcode::exchange::SendCommand& QrCode::_internal_send_command() const {
  return _internal_has_send_command()
      ? *qrcode_cmd_.send_command_
      : *reinterpret_cast< ::qrcode::exchange::SendCommand*>(&::qrcode::exchange::_SendCommand_default_instance_);
}
inline const ::qrcode::exchange::SendCommand& QrCode::send_command() const {
  // @@protoc_insertion_point(field_get:QrCode.send_command)
  return _internal_send_command();
}
inline ::qrcode::exchange::SendCommand* QrCode::_internal_mutable_send_command() {
  if (!_internal_has_send_command()) {
    clear_qrcode_cmd();
    set_has_send_command();
    qrcode_cmd_.send_command_ = CreateMaybeMessage< ::qrcode::exchange::SendCommand >(
        GetArenaNoVirtual());
  }
  return qrcode_cmd_.send_command_;
}
inline ::qrcode::exchange::SendCommand* QrCode::mutable_send_command() {
  // @@protoc_insertion_point(field_mutable:QrCode.send_command)
  return _internal_mutable_send_command();
}

inline bool QrCode::has_qrcode_cmd() const {
  return qrcode_cmd_case() != QRCODE_CMD_NOT_SET;
}
inline void QrCode::clear_has_qrcode_cmd() {
  _oneof_case_[0] = QRCODE_CMD_NOT_SET;
}
inline QrCode::QrcodeCmdCase QrCode::qrcode_cmd_case() const {
  return QrCode::QrcodeCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .cipurse.sam.AuthorizeHwSam authorize_sam = 1;
inline bool Cipurse::_internal_has_authorize_sam() const {
  return cipurse_cmd_case() == kAuthorizeSam;
}
inline bool Cipurse::has_authorize_sam() const {
  return _internal_has_authorize_sam();
}
inline void Cipurse::set_has_authorize_sam() {
  _oneof_case_[0] = kAuthorizeSam;
}
inline ::cipurse::sam::AuthorizeHwSam* Cipurse::release_authorize_sam() {
  // @@protoc_insertion_point(field_release:Cipurse.authorize_sam)
  if (_internal_has_authorize_sam()) {
    clear_has_cipurse_cmd();
      ::cipurse::sam::AuthorizeHwSam* temp = cipurse_cmd_.authorize_sam_;
    cipurse_cmd_.authorize_sam_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::sam::AuthorizeHwSam& Cipurse::_internal_authorize_sam() const {
  return _internal_has_authorize_sam()
      ? *cipurse_cmd_.authorize_sam_
      : *reinterpret_cast< ::cipurse::sam::AuthorizeHwSam*>(&::cipurse::sam::_AuthorizeHwSam_default_instance_);
}
inline const ::cipurse::sam::AuthorizeHwSam& Cipurse::authorize_sam() const {
  // @@protoc_insertion_point(field_get:Cipurse.authorize_sam)
  return _internal_authorize_sam();
}
inline ::cipurse::sam::AuthorizeHwSam* Cipurse::_internal_mutable_authorize_sam() {
  if (!_internal_has_authorize_sam()) {
    clear_cipurse_cmd();
    set_has_authorize_sam();
    cipurse_cmd_.authorize_sam_ = CreateMaybeMessage< ::cipurse::sam::AuthorizeHwSam >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.authorize_sam_;
}
inline ::cipurse::sam::AuthorizeHwSam* Cipurse::mutable_authorize_sam() {
  // @@protoc_insertion_point(field_mutable:Cipurse.authorize_sam)
  return _internal_mutable_authorize_sam();
}

// optional .cipurse.select.SelectFile select_file = 2;
inline bool Cipurse::_internal_has_select_file() const {
  return cipurse_cmd_case() == kSelectFile;
}
inline bool Cipurse::has_select_file() const {
  return _internal_has_select_file();
}
inline void Cipurse::set_has_select_file() {
  _oneof_case_[0] = kSelectFile;
}
inline ::cipurse::select::SelectFile* Cipurse::release_select_file() {
  // @@protoc_insertion_point(field_release:Cipurse.select_file)
  if (_internal_has_select_file()) {
    clear_has_cipurse_cmd();
      ::cipurse::select::SelectFile* temp = cipurse_cmd_.select_file_;
    cipurse_cmd_.select_file_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::select::SelectFile& Cipurse::_internal_select_file() const {
  return _internal_has_select_file()
      ? *cipurse_cmd_.select_file_
      : *reinterpret_cast< ::cipurse::select::SelectFile*>(&::cipurse::select::_SelectFile_default_instance_);
}
inline const ::cipurse::select::SelectFile& Cipurse::select_file() const {
  // @@protoc_insertion_point(field_get:Cipurse.select_file)
  return _internal_select_file();
}
inline ::cipurse::select::SelectFile* Cipurse::_internal_mutable_select_file() {
  if (!_internal_has_select_file()) {
    clear_cipurse_cmd();
    set_has_select_file();
    cipurse_cmd_.select_file_ = CreateMaybeMessage< ::cipurse::select::SelectFile >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.select_file_;
}
inline ::cipurse::select::SelectFile* Cipurse::mutable_select_file() {
  // @@protoc_insertion_point(field_mutable:Cipurse.select_file)
  return _internal_mutable_select_file();
}

// optional .cipurse.auth.EstablishSecureChannel establish_secure_channel = 3;
inline bool Cipurse::_internal_has_establish_secure_channel() const {
  return cipurse_cmd_case() == kEstablishSecureChannel;
}
inline bool Cipurse::has_establish_secure_channel() const {
  return _internal_has_establish_secure_channel();
}
inline void Cipurse::set_has_establish_secure_channel() {
  _oneof_case_[0] = kEstablishSecureChannel;
}
inline ::cipurse::auth::EstablishSecureChannel* Cipurse::release_establish_secure_channel() {
  // @@protoc_insertion_point(field_release:Cipurse.establish_secure_channel)
  if (_internal_has_establish_secure_channel()) {
    clear_has_cipurse_cmd();
      ::cipurse::auth::EstablishSecureChannel* temp = cipurse_cmd_.establish_secure_channel_;
    cipurse_cmd_.establish_secure_channel_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::auth::EstablishSecureChannel& Cipurse::_internal_establish_secure_channel() const {
  return _internal_has_establish_secure_channel()
      ? *cipurse_cmd_.establish_secure_channel_
      : *reinterpret_cast< ::cipurse::auth::EstablishSecureChannel*>(&::cipurse::auth::_EstablishSecureChannel_default_instance_);
}
inline const ::cipurse::auth::EstablishSecureChannel& Cipurse::establish_secure_channel() const {
  // @@protoc_insertion_point(field_get:Cipurse.establish_secure_channel)
  return _internal_establish_secure_channel();
}
inline ::cipurse::auth::EstablishSecureChannel* Cipurse::_internal_mutable_establish_secure_channel() {
  if (!_internal_has_establish_secure_channel()) {
    clear_cipurse_cmd();
    set_has_establish_secure_channel();
    cipurse_cmd_.establish_secure_channel_ = CreateMaybeMessage< ::cipurse::auth::EstablishSecureChannel >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.establish_secure_channel_;
}
inline ::cipurse::auth::EstablishSecureChannel* Cipurse::mutable_establish_secure_channel() {
  // @@protoc_insertion_point(field_mutable:Cipurse.establish_secure_channel)
  return _internal_mutable_establish_secure_channel();
}

// optional .cipurse.read_binary.ReadBinary read_binary = 4;
inline bool Cipurse::_internal_has_read_binary() const {
  return cipurse_cmd_case() == kReadBinary;
}
inline bool Cipurse::has_read_binary() const {
  return _internal_has_read_binary();
}
inline void Cipurse::set_has_read_binary() {
  _oneof_case_[0] = kReadBinary;
}
inline ::cipurse::read_binary::ReadBinary* Cipurse::release_read_binary() {
  // @@protoc_insertion_point(field_release:Cipurse.read_binary)
  if (_internal_has_read_binary()) {
    clear_has_cipurse_cmd();
      ::cipurse::read_binary::ReadBinary* temp = cipurse_cmd_.read_binary_;
    cipurse_cmd_.read_binary_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::read_binary::ReadBinary& Cipurse::_internal_read_binary() const {
  return _internal_has_read_binary()
      ? *cipurse_cmd_.read_binary_
      : *reinterpret_cast< ::cipurse::read_binary::ReadBinary*>(&::cipurse::read_binary::_ReadBinary_default_instance_);
}
inline const ::cipurse::read_binary::ReadBinary& Cipurse::read_binary() const {
  // @@protoc_insertion_point(field_get:Cipurse.read_binary)
  return _internal_read_binary();
}
inline ::cipurse::read_binary::ReadBinary* Cipurse::_internal_mutable_read_binary() {
  if (!_internal_has_read_binary()) {
    clear_cipurse_cmd();
    set_has_read_binary();
    cipurse_cmd_.read_binary_ = CreateMaybeMessage< ::cipurse::read_binary::ReadBinary >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.read_binary_;
}
inline ::cipurse::read_binary::ReadBinary* Cipurse::mutable_read_binary() {
  // @@protoc_insertion_point(field_mutable:Cipurse.read_binary)
  return _internal_mutable_read_binary();
}

// optional .cipurse.update_binary.UpdateBinary update_binary = 5;
inline bool Cipurse::_internal_has_update_binary() const {
  return cipurse_cmd_case() == kUpdateBinary;
}
inline bool Cipurse::has_update_binary() const {
  return _internal_has_update_binary();
}
inline void Cipurse::set_has_update_binary() {
  _oneof_case_[0] = kUpdateBinary;
}
inline ::cipurse::update_binary::UpdateBinary* Cipurse::release_update_binary() {
  // @@protoc_insertion_point(field_release:Cipurse.update_binary)
  if (_internal_has_update_binary()) {
    clear_has_cipurse_cmd();
      ::cipurse::update_binary::UpdateBinary* temp = cipurse_cmd_.update_binary_;
    cipurse_cmd_.update_binary_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::update_binary::UpdateBinary& Cipurse::_internal_update_binary() const {
  return _internal_has_update_binary()
      ? *cipurse_cmd_.update_binary_
      : *reinterpret_cast< ::cipurse::update_binary::UpdateBinary*>(&::cipurse::update_binary::_UpdateBinary_default_instance_);
}
inline const ::cipurse::update_binary::UpdateBinary& Cipurse::update_binary() const {
  // @@protoc_insertion_point(field_get:Cipurse.update_binary)
  return _internal_update_binary();
}
inline ::cipurse::update_binary::UpdateBinary* Cipurse::_internal_mutable_update_binary() {
  if (!_internal_has_update_binary()) {
    clear_cipurse_cmd();
    set_has_update_binary();
    cipurse_cmd_.update_binary_ = CreateMaybeMessage< ::cipurse::update_binary::UpdateBinary >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.update_binary_;
}
inline ::cipurse::update_binary::UpdateBinary* Cipurse::mutable_update_binary() {
  // @@protoc_insertion_point(field_mutable:Cipurse.update_binary)
  return _internal_mutable_update_binary();
}

// optional .cipurse.read_record.ReadRecord read_record = 6;
inline bool Cipurse::_internal_has_read_record() const {
  return cipurse_cmd_case() == kReadRecord;
}
inline bool Cipurse::has_read_record() const {
  return _internal_has_read_record();
}
inline void Cipurse::set_has_read_record() {
  _oneof_case_[0] = kReadRecord;
}
inline ::cipurse::read_record::ReadRecord* Cipurse::release_read_record() {
  // @@protoc_insertion_point(field_release:Cipurse.read_record)
  if (_internal_has_read_record()) {
    clear_has_cipurse_cmd();
      ::cipurse::read_record::ReadRecord* temp = cipurse_cmd_.read_record_;
    cipurse_cmd_.read_record_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::read_record::ReadRecord& Cipurse::_internal_read_record() const {
  return _internal_has_read_record()
      ? *cipurse_cmd_.read_record_
      : *reinterpret_cast< ::cipurse::read_record::ReadRecord*>(&::cipurse::read_record::_ReadRecord_default_instance_);
}
inline const ::cipurse::read_record::ReadRecord& Cipurse::read_record() const {
  // @@protoc_insertion_point(field_get:Cipurse.read_record)
  return _internal_read_record();
}
inline ::cipurse::read_record::ReadRecord* Cipurse::_internal_mutable_read_record() {
  if (!_internal_has_read_record()) {
    clear_cipurse_cmd();
    set_has_read_record();
    cipurse_cmd_.read_record_ = CreateMaybeMessage< ::cipurse::read_record::ReadRecord >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.read_record_;
}
inline ::cipurse::read_record::ReadRecord* Cipurse::mutable_read_record() {
  // @@protoc_insertion_point(field_mutable:Cipurse.read_record)
  return _internal_mutable_read_record();
}

// optional .cipurse.update_record.UpdateRecord update_record = 7;
inline bool Cipurse::_internal_has_update_record() const {
  return cipurse_cmd_case() == kUpdateRecord;
}
inline bool Cipurse::has_update_record() const {
  return _internal_has_update_record();
}
inline void Cipurse::set_has_update_record() {
  _oneof_case_[0] = kUpdateRecord;
}
inline ::cipurse::update_record::UpdateRecord* Cipurse::release_update_record() {
  // @@protoc_insertion_point(field_release:Cipurse.update_record)
  if (_internal_has_update_record()) {
    clear_has_cipurse_cmd();
      ::cipurse::update_record::UpdateRecord* temp = cipurse_cmd_.update_record_;
    cipurse_cmd_.update_record_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::update_record::UpdateRecord& Cipurse::_internal_update_record() const {
  return _internal_has_update_record()
      ? *cipurse_cmd_.update_record_
      : *reinterpret_cast< ::cipurse::update_record::UpdateRecord*>(&::cipurse::update_record::_UpdateRecord_default_instance_);
}
inline const ::cipurse::update_record::UpdateRecord& Cipurse::update_record() const {
  // @@protoc_insertion_point(field_get:Cipurse.update_record)
  return _internal_update_record();
}
inline ::cipurse::update_record::UpdateRecord* Cipurse::_internal_mutable_update_record() {
  if (!_internal_has_update_record()) {
    clear_cipurse_cmd();
    set_has_update_record();
    cipurse_cmd_.update_record_ = CreateMaybeMessage< ::cipurse::update_record::UpdateRecord >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.update_record_;
}
inline ::cipurse::update_record::UpdateRecord* Cipurse::mutable_update_record() {
  // @@protoc_insertion_point(field_mutable:Cipurse.update_record)
  return _internal_mutable_update_record();
}

// optional .cipurse.append_record.AppendRecord append_record = 8;
inline bool Cipurse::_internal_has_append_record() const {
  return cipurse_cmd_case() == kAppendRecord;
}
inline bool Cipurse::has_append_record() const {
  return _internal_has_append_record();
}
inline void Cipurse::set_has_append_record() {
  _oneof_case_[0] = kAppendRecord;
}
inline ::cipurse::append_record::AppendRecord* Cipurse::release_append_record() {
  // @@protoc_insertion_point(field_release:Cipurse.append_record)
  if (_internal_has_append_record()) {
    clear_has_cipurse_cmd();
      ::cipurse::append_record::AppendRecord* temp = cipurse_cmd_.append_record_;
    cipurse_cmd_.append_record_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::append_record::AppendRecord& Cipurse::_internal_append_record() const {
  return _internal_has_append_record()
      ? *cipurse_cmd_.append_record_
      : *reinterpret_cast< ::cipurse::append_record::AppendRecord*>(&::cipurse::append_record::_AppendRecord_default_instance_);
}
inline const ::cipurse::append_record::AppendRecord& Cipurse::append_record() const {
  // @@protoc_insertion_point(field_get:Cipurse.append_record)
  return _internal_append_record();
}
inline ::cipurse::append_record::AppendRecord* Cipurse::_internal_mutable_append_record() {
  if (!_internal_has_append_record()) {
    clear_cipurse_cmd();
    set_has_append_record();
    cipurse_cmd_.append_record_ = CreateMaybeMessage< ::cipurse::append_record::AppendRecord >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.append_record_;
}
inline ::cipurse::append_record::AppendRecord* Cipurse::mutable_append_record() {
  // @@protoc_insertion_point(field_mutable:Cipurse.append_record)
  return _internal_mutable_append_record();
}

// optional .cipurse.read_value.ReadValue read_value = 9;
inline bool Cipurse::_internal_has_read_value() const {
  return cipurse_cmd_case() == kReadValue;
}
inline bool Cipurse::has_read_value() const {
  return _internal_has_read_value();
}
inline void Cipurse::set_has_read_value() {
  _oneof_case_[0] = kReadValue;
}
inline ::cipurse::read_value::ReadValue* Cipurse::release_read_value() {
  // @@protoc_insertion_point(field_release:Cipurse.read_value)
  if (_internal_has_read_value()) {
    clear_has_cipurse_cmd();
      ::cipurse::read_value::ReadValue* temp = cipurse_cmd_.read_value_;
    cipurse_cmd_.read_value_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::read_value::ReadValue& Cipurse::_internal_read_value() const {
  return _internal_has_read_value()
      ? *cipurse_cmd_.read_value_
      : *reinterpret_cast< ::cipurse::read_value::ReadValue*>(&::cipurse::read_value::_ReadValue_default_instance_);
}
inline const ::cipurse::read_value::ReadValue& Cipurse::read_value() const {
  // @@protoc_insertion_point(field_get:Cipurse.read_value)
  return _internal_read_value();
}
inline ::cipurse::read_value::ReadValue* Cipurse::_internal_mutable_read_value() {
  if (!_internal_has_read_value()) {
    clear_cipurse_cmd();
    set_has_read_value();
    cipurse_cmd_.read_value_ = CreateMaybeMessage< ::cipurse::read_value::ReadValue >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.read_value_;
}
inline ::cipurse::read_value::ReadValue* Cipurse::mutable_read_value() {
  // @@protoc_insertion_point(field_mutable:Cipurse.read_value)
  return _internal_mutable_read_value();
}

// optional .cipurse.modify_value.ModifyValue modify_value = 10;
inline bool Cipurse::_internal_has_modify_value() const {
  return cipurse_cmd_case() == kModifyValue;
}
inline bool Cipurse::has_modify_value() const {
  return _internal_has_modify_value();
}
inline void Cipurse::set_has_modify_value() {
  _oneof_case_[0] = kModifyValue;
}
inline ::cipurse::modify_value::ModifyValue* Cipurse::release_modify_value() {
  // @@protoc_insertion_point(field_release:Cipurse.modify_value)
  if (_internal_has_modify_value()) {
    clear_has_cipurse_cmd();
      ::cipurse::modify_value::ModifyValue* temp = cipurse_cmd_.modify_value_;
    cipurse_cmd_.modify_value_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::cipurse::modify_value::ModifyValue& Cipurse::_internal_modify_value() const {
  return _internal_has_modify_value()
      ? *cipurse_cmd_.modify_value_
      : *reinterpret_cast< ::cipurse::modify_value::ModifyValue*>(&::cipurse::modify_value::_ModifyValue_default_instance_);
}
inline const ::cipurse::modify_value::ModifyValue& Cipurse::modify_value() const {
  // @@protoc_insertion_point(field_get:Cipurse.modify_value)
  return _internal_modify_value();
}
inline ::cipurse::modify_value::ModifyValue* Cipurse::_internal_mutable_modify_value() {
  if (!_internal_has_modify_value()) {
    clear_cipurse_cmd();
    set_has_modify_value();
    cipurse_cmd_.modify_value_ = CreateMaybeMessage< ::cipurse::modify_value::ModifyValue >(
        GetArenaNoVirtual());
  }
  return cipurse_cmd_.modify_value_;
}
inline ::cipurse::modify_value::ModifyValue* Cipurse::mutable_modify_value() {
  // @@protoc_insertion_point(field_mutable:Cipurse.modify_value)
  return _internal_mutable_modify_value();
}

inline bool Cipurse::has_cipurse_cmd() const {
  return cipurse_cmd_case() != CIPURSE_CMD_NOT_SET;
}
inline void Cipurse::clear_has_cipurse_cmd() {
  _oneof_case_[0] = CIPURSE_CMD_NOT_SET;
}
inline Cipurse::CipurseCmdCase Cipurse::cipurse_cmd_case() const {
  return Cipurse::CipurseCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .turnstile.passage.AllowOnePass allow_one_pass = 1;
inline bool Turnstile::_internal_has_allow_one_pass() const {
  return turnstile_cmd_case() == kAllowOnePass;
}
inline bool Turnstile::has_allow_one_pass() const {
  return _internal_has_allow_one_pass();
}
inline void Turnstile::set_has_allow_one_pass() {
  _oneof_case_[0] = kAllowOnePass;
}
inline ::turnstile::passage::AllowOnePass* Turnstile::release_allow_one_pass() {
  // @@protoc_insertion_point(field_release:Turnstile.allow_one_pass)
  if (_internal_has_allow_one_pass()) {
    clear_has_turnstile_cmd();
      ::turnstile::passage::AllowOnePass* temp = turnstile_cmd_.allow_one_pass_;
    turnstile_cmd_.allow_one_pass_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::turnstile::passage::AllowOnePass& Turnstile::_internal_allow_one_pass() const {
  return _internal_has_allow_one_pass()
      ? *turnstile_cmd_.allow_one_pass_
      : *reinterpret_cast< ::turnstile::passage::AllowOnePass*>(&::turnstile::passage::_AllowOnePass_default_instance_);
}
inline const ::turnstile::passage::AllowOnePass& Turnstile::allow_one_pass() const {
  // @@protoc_insertion_point(field_get:Turnstile.allow_one_pass)
  return _internal_allow_one_pass();
}
inline ::turnstile::passage::AllowOnePass* Turnstile::_internal_mutable_allow_one_pass() {
  if (!_internal_has_allow_one_pass()) {
    clear_turnstile_cmd();
    set_has_allow_one_pass();
    turnstile_cmd_.allow_one_pass_ = CreateMaybeMessage< ::turnstile::passage::AllowOnePass >(
        GetArenaNoVirtual());
  }
  return turnstile_cmd_.allow_one_pass_;
}
inline ::turnstile::passage::AllowOnePass* Turnstile::mutable_allow_one_pass() {
  // @@protoc_insertion_point(field_mutable:Turnstile.allow_one_pass)
  return _internal_mutable_allow_one_pass();
}

inline bool Turnstile::has_turnstile_cmd() const {
  return turnstile_cmd_case() != TURNSTILE_CMD_NOT_SET;
}
inline void Turnstile::clear_has_turnstile_cmd() {
  _oneof_case_[0] = TURNSTILE_CMD_NOT_SET;
}
inline Turnstile::TurnstileCmdCase Turnstile::turnstile_cmd_case() const {
  return Turnstile::TurnstileCmdCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional .troika.av3.read_ticket.ReadTicket troika_av3_read_ticket = 1;
inline bool TroikaCard::_internal_has_troika_av3_read_ticket() const {
  return troika_cmd_case() == kTroikaAv3ReadTicket;
}
inline bool TroikaCard::has_troika_av3_read_ticket() const {
  return _internal_has_troika_av3_read_ticket();
}
inline void TroikaCard::set_has_troika_av3_read_ticket() {
  _oneof_case_[0] = kTroikaAv3ReadTicket;
}
inline ::troika::av3::read_ticket::ReadTicket* TroikaCard::release_troika_av3_read_ticket() {
  // @@protoc_insertion_point(field_release:TroikaCard.troika_av3_read_ticket)
  if (_internal_has_troika_av3_read_ticket()) {
    clear_has_troika_cmd();
      ::troika::av3::read_ticket::ReadTicket* temp = troika_cmd_.troika_av3_read_ticket_;
    troika_cmd_.troika_av3_read_ticket_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::troika::av3::read_ticket::ReadTicket& TroikaCard::_internal_troika_av3_read_ticket() const {
  return _internal_has_troika_av3_read_ticket()
...
inline const ::troika::av3::read_ticket::ReadTicket& TroikaCard::troika_av3_read_ticket() const {
  // @@protoc_insertion_point(field_get:TroikaCard.troika_av3_read_ticket)
  return _internal_troika_av3_read_ticket();
}
inline ::troika::av3::read_ticket::ReadTicket* TroikaCard::_internal_mutable_troika_av3_read_ticket() {
  if (!_internal_has_troika_av3_read_ticket()) {
    clear_troika_cmd();
    set_has_troika_av3_read_ticket();
    troika_cmd_.troika_av3_read_ticket_ = CreateMaybeMessage< ::troika::av3::read_ticket::ReadTicket >(
        GetArenaNoVirtual());
  }
  return troika_cmd_.troika_av3_read_ticket_;
}
inline ::troika::av3::read_ticket::ReadTicket* TroikaCard::mutable_troika_av3_read_ticket() {
  // @@protoc_insertion_point(field_mutable:TroikaCard.troika_av3_read_ticket)
  return _internal_mutable_troika_av3_read_ticket();
}

// optional .troika.av3.write_ticket.WriteTicket troika_av3_write_ticket = 2;
inline bool TroikaCard::_internal_has_troika_av3_write_ticket() const {
  return troika_cmd_case() == kTroikaAv3WriteTicket;
}
inline bool TroikaCard::has_troika_av3_write_ticket() const {
  return _internal_has_troika_av3_write_ticket();
}
inline void TroikaCard::set_has_troika_av3_write_ticket() {
  _oneof_case_[0] = kTroikaAv3WriteTicket;
}
inline ::troika::av3::write_ticket::WriteTicket* TroikaCard::release_troika_av3_write_ticket() {
  // @@protoc_insertion_point(field_release:TroikaCard.troika_av3_write_ticket)
  if (_internal_has_troika_av3_write_ticket()) {
    clear_has_troika_cmd();
      ::troika::av3::write_ticket::WriteTicket* temp = troika_cmd_.troika_av3_write_ticket_;
    troika_cmd_.troika_av3_write_ticket_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::troika::av3::write_ticket::WriteTicket& TroikaCard::_internal_troika_av3_write_ticket() const {
  return _internal_has_troika_av3_write_ticket()
      ? *troika_cmd_.troika_av3_write_ticket_
      : *reinterpret_cast< ::troika::av3::write_ticket::WriteTicket*>(&::troika::av3::write_ticket::_WriteTicket_default_instance_);
}
inline const ::troika::av3::write_ticket::WriteTicket& TroikaCard::troika_av3_write_ticket() const {
  // @@protoc_insertion_point(field_get:TroikaCard.troika_av3_write_ticket)
  return _internal_troika_av3_write_ticket();
}
inline ::troika::av3::write_ticket::WriteTicket* TroikaCard::_internal_mutable_troika_av3_write_ticket() {
  if (!_internal_has_troika_av3_write_ticket()) {
    clear_troika_cmd();
    set_has_troika_av3_write_ticket();
    troika_cmd_.troika_av3_write_ticket_ = CreateMaybeMessage< ::troika::av3::write_ticket::WriteTicket >(
        GetArenaNoVirtual());
  }
  return troika_cmd_.troika_av3_write_ticket_;
}
inline ::troika::av3::write_ticket::WriteTicket* TroikaCard::mutable_troika_av3_write_ticket() {
  // @@protoc_insertion_point(field_mutable:TroikaCard.troika_av3_write_ticket)
  return _internal_mutable_troika_av3_write_ticket();
}

inline bool TroikaCard::has_troika_cmd() const {
  return troika_cmd_case() != TROIKA_CMD_NOT_SET;
}
inline void TroikaCard::clear_has_troika_cmd() {
  _oneof_case_[0] = TROIKA_CMD_NOT_SET;
}
inline TroikaCard::TroikaCmdCase TroikaCard::troika_cmd_case() const {
  return TroikaCard::TroikaCmdCase(_oneof_case_[0]);
}
#ifdef __GNUC__
