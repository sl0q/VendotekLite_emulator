...
#ifndef GOOGLE_PROTOBUF_INCLUDED_contactless_2femv_5ftag_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_contactless_2femv_5ftag_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_contactless_2femv_5ftag_2eproto
...
struct TableStruct_contactless_2femv_5ftag_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_contactless_2femv_5ftag_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::contactless::emv_tag::EmvTag* Arena::CreateMaybeMessage<::contactless::emv_tag::EmvTag>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace contactless {
namespace emv_tag {
...
class EmvTag :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contactless.emv_tag.EmvTag) */ {
 public:
  EmvTag();
  virtual ~EmvTag();
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "contactless.emv_tag.EmvTag";
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_contactless_2femv_5ftag_2eproto);
    return ::descriptor_table_contactless_2femv_5ftag_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:contactless.emv_tag.EmvTag)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_contactless_2femv_5ftag_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 EmvTag::number() const {
  // @@protoc_insertion_point(field_get:contactless.emv_tag.EmvTag.number)
...
inline void EmvTag::set_number(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:contactless.emv_tag.EmvTag.number)
}
...
inline const std::string& EmvTag::value() const {
  // @@protoc_insertion_point(field_get:contactless.emv_tag.EmvTag.value)
  return _internal_value();
}
inline void EmvTag::set_value(const std::string& value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:contactless.emv_tag.EmvTag.value)
}
inline std::string* EmvTag::mutable_value() {
  // @@protoc_insertion_point(field_mutable:contactless.emv_tag.EmvTag.value)
...
inline void EmvTag::set_value(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:contactless.emv_tag.EmvTag.value)
}
inline void EmvTag::set_value(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  value_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:contactless.emv_tag.EmvTag.value)
}
inline void EmvTag::set_value(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  value_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:contactless.emv_tag.EmvTag.value)
}
...
inline std::string* EmvTag::release_value() {
  // @@protoc_insertion_point(field_release:contactless.emv_tag.EmvTag.value)
...
inline void EmvTag::set_allocated_value(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:contactless.emv_tag.EmvTag.value)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_contactless_2femv_5ftag_2eproto
