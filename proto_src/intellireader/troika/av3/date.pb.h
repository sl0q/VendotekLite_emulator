...
#ifndef GOOGLE_PROTOBUF_INCLUDED_troika_2fav3_2fdate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_troika_2fav3_2fdate_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_troika_2fav3_2fdate_2eproto
...
struct TableStruct_troika_2fav3_2fdate_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_troika_2fav3_2fdate_2eproto;
namespace troika {
namespace av3 {
namespace date {
class Date;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::troika::av3::date::Date* Arena::CreateMaybeMessage<::troika::av3::date::Date>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace troika {
namespace av3 {
namespace date {
...
class Date :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:troika.av3.date.Date) */ {
 public:
  Date();
  virtual ~Date();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_troika_2fav3_2fdate_2eproto);
    return ::descriptor_table_troika_2fav3_2fdate_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_troika_2fav3_2fdate_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::day() const {
  // @@protoc_insertion_point(field_get:troika.av3.date.Date.day)
...
inline void Date::set_day(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:troika.av3.date.Date.day)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::month() const {
  // @@protoc_insertion_point(field_get:troika.av3.date.Date.month)
...
inline void Date::set_month(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:troika.av3.date.Date.month)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Date::year() const {
  // @@protoc_insertion_point(field_get:troika.av3.date.Date.year)
...
inline void Date::set_year(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:troika.av3.date.Date.year)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_troika_2fav3_2fdate_2eproto
